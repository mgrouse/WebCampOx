...
import org.hbgb.webcamp.shared.TeacherHistoryRecord;
...
PersistenceCapable {
    ...
    private static final long serialVersionUID = 5054336178747710391L;

    static {
        jdoFieldNames = Teacher.__jdoFieldNamesInit();
        jdoFieldTypes = Teacher.__jdoFieldTypesInit();
        jdoFieldFlags = Teacher.__jdoFieldFlagsInit();
        jdoInheritedFieldCount = Teacher.__jdoGetInheritedFieldCount();
        jdoPersistenceCapableSuperclass = Teacher.__jdoPersistenceCapableSuperclassInit();
        JDOImplHelper.registerClass((Class)Teacher.___jdo$loadClass("org.hbgb.webcamp.shared.Teacher"), (String[])jdoFieldNames, (Class[])jdoFieldTypes, (byte[])jdoFieldFlags, (Class)jdoPersistenceCapableSuperclass, (PersistenceCapable)new Teacher());
    }
    ...
    protected final void jdoCopyField(Teacher obj, int index) {
        switch (index - jdoInheritedFieldCount) {
            case 0: {
    ...
    public void jdoCopyFields(Object obj, int[] indices) {
        ...
        if (!(obj instanceof Teacher)) {
            throw new IllegalArgumentException("object is not an object of type org.hbgb.webcamp.shared.Teacher");
        }
    ...
    private static final Class[] __jdoFieldTypesInit() {
        return new Class[]{Teacher.___jdo$loadClass("java.lang.String"), Teacher.___jdo$loadClass("java.util.List")};
    }
    ...
    private static Class __jdoPersistenceCapableSuperclassInit() {
        return Teacher.___jdo$loadClass("org.hbgb.webcamp.shared.Burner");
    }
    ...
    private static String jdoGetencodedKey(Teacher objPC) {
        return objPC.encodedKey;
    }

    private static void jdoSetencodedKey(Teacher objPC, String val) {
    ...
    private static List jdoGethistory(Teacher objPC) {
    ...
    private static void jdoSethistory(Teacher objPC, List val) {
        if (objPC.jdoStateManager == null) {
            objPC.history = val;
        } else {
