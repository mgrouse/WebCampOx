...
public class TeacherHistoryRecord
...
PersistenceCapable {
    ...
    private static final long serialVersionUID = -4482255747606980464L;

    static {
        jdoFieldNames = TeacherHistoryRecord.__jdoFieldNamesInit();
        jdoFieldTypes = TeacherHistoryRecord.__jdoFieldTypesInit();
        jdoFieldFlags = TeacherHistoryRecord.__jdoFieldFlagsInit();
        jdoInheritedFieldCount = TeacherHistoryRecord.__jdoGetInheritedFieldCount();
        jdoPersistenceCapableSuperclass = TeacherHistoryRecord.__jdoPersistenceCapableSuperclassInit();
        JDOImplHelper.registerClass((Class)TeacherHistoryRecord.___jdo$loadClass("org.hbgb.webcamp.shared.TeacherHistoryRecord"), (String[])jdoFieldNames, (Class[])jdoFieldTypes, (byte[])jdoFieldFlags, (Class)jdoPersistenceCapableSuperclass, (PersistenceCapable)new TeacherHistoryRecord());
    }
    ...
    public PersistenceCapable jdoNewInstance(StateManager sm) {
        TeacherHistoryRecord result = new TeacherHistoryRecord();
        result.jdoFlags = 1;
    ...
    protected final void jdoCopyField(TeacherHistoryRecord obj, int index) {
        switch (index) {
            case 0: {
    ...
    public void jdoCopyFields(Object obj, int[] indices) {
        ...
        if (!(obj instanceof TeacherHistoryRecord)) {
            throw new IllegalArgumentException("object is not an object of type org.hbgb.webcamp.shared.TeacherHistoryRecord");
        }
        TeacherHistoryRecord other = (TeacherHistoryRecord)obj;
    ...
    private static final String[] __jdoFieldNamesInit() {
        return new String[]{"email", "encodedKey"};
    }

    private static final Class[] __jdoFieldTypesInit() {
        return new Class[]{TeacherHistoryRecord.___jdo$loadClass("java.lang.String"), TeacherHistoryRecord.___jdo$loadClass("java.lang.String")};
    }
    ...
    private Object jdoSuperClone() throws CloneNotSupportedException {
        TeacherHistoryRecord o = (TeacherHistoryRecord)super.clone();
        o.jdoFlags = 0;
    ...
    private static String jdoGetemail(TeacherHistoryRecord objPC) {
    ...
    private static void jdoSetemail(TeacherHistoryRecord objPC, String val) {
    ...
    private static String jdoGetencodedKey(TeacherHistoryRecord objPC) {
        return objPC.encodedKey;
    }

    private static void jdoSetencodedKey(TeacherHistoryRecord objPC, String val) {
