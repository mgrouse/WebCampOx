...
public enum DayOfEvent
{
	...
	private static DayOfEvent[] val = new DayOfEvent[] { StarMan_Saturday, StarMan_Sunday, Early_Monday, Early_Tuesday, Early_Wednesday,
			Early_Thursday, Early_Friday, Early_Saturday, Early_Sunday, Burn_Monday, Burn_Tuesday, Burn_Wednesday, Burn_Thursday, Burn_Friday,
			Burn_Saturday, Burn_Sunday, Exodus_Monday, Exodus_Tuesday };
