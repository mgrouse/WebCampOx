...
{
	private static UiBinder<Widget, InputHealerSheetInfoViewImpl> binder = (UiBinder) GWT
			.create((Class) InputHealerSheetInfoViewImplBinder.class);
	@UiField
	...
	public InputHealerSheetInfoViewImpl()
	{
