...
public class ApplicationLookupByEmailPresenter
            ...
            this.rpcService.findApplicationKeyByEmail(this.email, new AsyncCallback<String>(){
                ...
                public void onSuccess(String result) {
                    if (result == null) {
                        ...
                        ApplicationLookupByEmailPresenter.this.view.setWarningText(ApplicationLookupByEmailPresenter.this.getMissingEmailWarningText());
