...
import org.hbgb.webcamp.client.presenter.admin.IEarlyTeamMemberPresenter;
...
public class EarlyTeamMemberPresenter
implements IEarlyTeamMemberPresenter {
    ...
    public void onSaveButtonClicked() {
        this.setModel();
        this.model.putData();
        this.eventBus.fireEvent((GwtEvent)new ListUserEvent());
    }
